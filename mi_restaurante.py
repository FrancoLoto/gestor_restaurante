...
def total():
    ...
    var_costos_postre.set(f'$ {round(sub_total_postres, 2)}')
...
def recibo():
    ...
    texto_recibo.insert(END, f' Costo de los postres: \t\t\t{var_costos_postre.get()}\n')
    texto_recibo.insert(END, f'-' * 54 + '\n')
...
aplicacion.title('Restaurante Loto - Sistema de facturación')
...
# lista de productos
lista_comidas = ['pollo', 'cordero', 'salmon', 'ravioles', 'sorrentinos', 'pizza1', 'pizza2', 'pizza3']
lista_bebidas = ['agua', 'soda', 'cola', 'vino', 'cerveza1', 'cerveza2']
lista_postres = ['flan', 'helado', 'mouse', 'pastel1', 'pastel2']
